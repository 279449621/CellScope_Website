...
**Y_1**, **Y_all**, **index_1**, **index_all**, **main_radius** = 2.0, **orbit_radius** = 1.5, **orbit_distance**=4.0, **branch_params**=None, **save_fig**=False, **save_path**='')
...
- **orbit_radiu** (:class:`float`,optional, default=1.5):

   The node radius of the first-layer nodes.

- **orbit_distance** (:class:`float`, optional, default=4): 
...
- The function returns two dictionaries, R_dict and C_dict, which record the node radii and center coordinates for plotting, respectively, while also outputting the modular components of the tree-structured visualization for assembly.
